...
map("n", "<C-h>", "<C-w>h", { desc = I18n.translate("win","left") })
map("n", "<C-j>", "<C-w>j", { desc = I18n.translate("win","lower") })
map("n", "<C-k>", "<C-w>k", { desc = I18n.translate("win","upper") })
map("n", "<C-l>", "<C-w>l", { desc = I18n.translate("win","right") })

-- Resize window using <ctrl> arrow keys
map("n", "<C-Up>", "<cmd>resize +2<cr>", { desc = I18n.translate("winSize","hIn") })
map("n", "<C-Down>", "<cmd>resize -2<cr>", { desc = I18n.translate("winSize","hDe") })
map("n", "<C-Left>", "<cmd>vertical resize -2<cr>", { desc = I18n.translate("winSize","wIn") })
map("n", "<C-Right>", "<cmd>vertical resize +2<cr>", { desc = I18n.translate("winSize","wDe") })
...
-- toggle options
map("n", "<leader>uf", require("lvim.plugins.lsp.format").toggle, { desc = "Toggle format on Save" })
